...
from baylime.discretize import QuartileDiscretizer
from baylime.discretize import DecileDiscretizer
from baylime.discretize import EntropyDiscretizer
from baylime.discretize import BaseDiscretizer
from baylime.discretize import StatsDiscretizer
...
class RecurrentTabularExplainer(LimeTabularExplainer):
    ...
    def explain_instance(self, data_row, classifier_fn, labels=(1,),
                         ...
                         distance_metric='euclidean', model_regressor='non_Bay'):
        """Generates explanations for a prediction.
